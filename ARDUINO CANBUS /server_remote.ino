...
unsigned char valor_fuel[] = {90, 111, 96, 103, 100, 118, 130, 125, 108, 99};
unsigned char valor_oxigen1[] = {20, 40, 60, 80, 100, 110, 120, 140, 160, 180 };
unsigned char valor_oxigen2[] = {116,118,120,122,124,126,128,130,134,140};
...
START_INIT:
    ...
    else
    {
     ...
     CAN.attachInterrupt(0, MCP2515_ISR, FALLING); 
}
...
void loop()
{
    if(Flag_Recv) // Comprobamos si hay una petición pendiente
    {
        ...
        if (doResponse){
            ...
            CAN.sendMsgBuf(DIR_CLIENT, 0, 3, stmp); 
